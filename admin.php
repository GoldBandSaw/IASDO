...
<body data-page="admin">
  <div class="app-shell">
    <aside class="sidebar">
      ...
      <nav><a class="nav-item active" href="admin.php"><span>▦</span> Propositions</a><a class="nav-item" href="courses.html"><span>▣</span> Mes cours</a><a class="nav-item" href="index.html"><span>⌂</span> Retour au site</a></nav>
    </aside>
